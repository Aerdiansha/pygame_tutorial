...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image_ori = random.choice(meteor_imgs)
...
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        self.rect.y += self.speedy
        # kill if it moves to the top of the screen
...
background = pygame.transform.scale(background, (WIDTH, HEIGHT)) # change the size of the background
